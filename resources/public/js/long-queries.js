...
$(document).ready(function () {
    ...
    function displayProcesses(processes) {
        ...
        processes.forEach(function (process) {
        	...
        	addInfo('Instance', '<a href="https://bakufu/web/search?s='+process.InstanceHostname+':'+process.InstancePort+'"><code class="text-primary">'+process.InstanceHostname+":"+process.InstancePort+'</code></a>');
        	...
        	infoDiv.html(infoDiv.html() + '<div><a href="https://bakufu/web/search?s='+process.InstanceHostname+":"+process.InstancePort+'"><code class="text-primary">'+process.InstanceHostname+":"+process.InstancePort+'</code></a></div>');
